 ...
 class ConectorDB{
	...
	*/
	...
	function access($USR,$PASS){
		...
		$stSql ="SELECT usuario.usr_id, usuario.usr_username, usuario.usr_password, usuario.usr_nombres, usuario.usr_apellidos FROM usuario ".
				"WHERE usr_username='".$USR."' AND usr_password='".$PASS."'";
